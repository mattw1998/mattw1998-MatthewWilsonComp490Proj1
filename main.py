    ...
    while True:
        ...
        if event == 'SELECT':
            try:
                ...
                job_description = SQL_Job_Search('description', index, cur)
                window['-JOB_DESC-'].update(job_description)

                company = SQL_Job_Search('company', index, cur)
        ...
        if event == 'Generate':
            ...
            job_info.append(list(SQL_Job_Search('title', job_index, cur)))
            job_info.append(list(SQL_Job_Search('description', job_index, cur)))
